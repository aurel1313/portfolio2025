 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace GetDomainsDomains$ {
    /** @deprecated use `GetDomainsDomains$inboundSchema` instead. */
    const inboundSchema: z.ZodType<GetDomainsDomains, z.ZodTypeDef, unknown>;
    /** @deprecated use `GetDomainsDomains$outboundSchema` instead. */
    const outboundSchema: z.ZodType<GetDomainsDomains$Outbound, z.ZodTypeDef, GetDomainsDomains>;
    /** @deprecated use `GetDomainsDomains$Outbound` instead. */
    type Outbound = GetDomainsDomains$Outbound;
}
