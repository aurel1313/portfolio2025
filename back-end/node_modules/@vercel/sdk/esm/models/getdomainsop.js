 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var GetDomainsDomains$;
(function (GetDomainsDomains$) {
    /** @deprecated use `GetDomainsDomains$inboundSchema` instead. */
    GetDomainsDomains$.inboundSchema = GetDomainsDomains$inboundSchema;
    /** @deprecated use `GetDomainsDomains$outboundSchema` instead. */
    GetDomainsDomains$.outboundSchema = GetDomainsDomains$outboundSchema;
