...
/** @internal */
export const GetConfigurationTransferRequestKind$inboundSchema = z.nativeEnum(GetConfigurationTransferRequestKind);
/** @internal */
export const GetConfigurationTransferRequestKind$outboundSchema = GetConfigurationTransferRequestKind$inboundSchema;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var GetConfigurationTransferRequestKind$;
(function (GetConfigurationTransferRequestKind$) {
    /** @deprecated use `GetConfigurationTransferRequestKind$inboundSchema` instead. */
    GetConfigurationTransferRequestKind$.inboundSchema = GetConfigurationTransferRequestKind$inboundSchema;
    /** @deprecated use `GetConfigurationTransferRequestKind$outboundSchema` instead. */
    GetConfigurationTransferRequestKind$.outboundSchema = GetConfigurationTransferRequestKind$outboundSchema;
})(GetConfigurationTransferRequestKind$ || (GetConfigurationTransferRequestKind$ = {}));
/** @internal */
