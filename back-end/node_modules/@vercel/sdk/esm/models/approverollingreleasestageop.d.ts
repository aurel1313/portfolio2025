 ...
 */
export declare const ApproveRollingReleaseStageSubstate: {
    readonly Paused: "PAUSED";
};
/**
 * When set to `PAUSED`, the rollout is frozen at the current percentage until continued.
 */
export type ApproveRollingReleaseStageSubstate = ClosedEnum<typeof ApproveRollingReleaseStageSubstate>;
/**
...
/** @internal */
export declare const ApproveRollingReleaseStageSubstate$inboundSchema: z.ZodNativeEnum<typeof ApproveRollingReleaseStageSubstate>;
/** @internal */
export declare const ApproveRollingReleaseStageSubstate$outboundSchema: z.ZodNativeEnum<typeof ApproveRollingReleaseStageSubstate>;
/** @internal */
