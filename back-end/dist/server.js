...
import { BASE_URL, isDevelopment } from "./utils/utils.js";
...
const getResponseProfil = async (message) => {
...
app.post("/gemini", async (req, res) => {
    try {
        ...
        //message ne doit pas etre vide
            ...
            res.json({
                response: "Je suis désolé, je ne peux répondre qu'aux questions sur mon CV ou le projet Taekna.",
            });
        }
    }
    catch (error) {
